...
if __name__ == "__main__":
    ...
    markdown_text = docx_to_markdown.convert(r"C:\Users\Administrator\Desktop\培训资料\Docs\技术方案\密码应用方案\密码应用集成方案.docx")
    print(markdown_text)
    
    # 按标题分块并获取章节信息
    chunks = docx_to_markdown.convert_and_chunk(r"C:\Users\Administrator\Desktop\培训资料\Docs\技术方案\密码应用方案\密码应用集成方案.docx")
    print(f"\n总共分成了 {len(chunks)} 个块")
    for i, chunk in enumerate(chunks[:3]):  # 只打印前3个块作为示例
        print(f"\n块 {i+1}:")
